...
class _UsuariosPageState extends State<UsuariosPage> {
  ...
  Widget build(BuildContext context) {
    //traer el nombre del usuario a la parte superior
        ...
        appBar: AppBar(
          ...
          leading: IconButton(
            ...
            onPressed: () {
              ...
              //sacar a el usuario de la pantalla
              Navigator.pushReplacementNamed(context, 'login');
              //referencia al metodo estatico
              AuthService.deleteToken(); //borra la informacio
            },
          ),
          actions: <Widget>[
            Container(
